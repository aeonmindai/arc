...
pub(crate) const GATHER_GEMV_MAX_PAIRS: usize = CUDA_MAX_GRID_DIM_Y;

/// Env override for the fused-gather token cap (both rungs). Absolute token
/// count; still clamped by [`GATHER_GEMV_MAX_PAIRS`].
pub(crate) const ONDEVICE_MOE_MAX_TOKENS_ENV: &str = "ARC_QTIP_ONDEVICE_MOE_MAX_TOKENS";
...
pub(crate) fn expected_distinct_experts(n_tokens: usize, top_k: usize, num_experts: usize) -> f64 {
