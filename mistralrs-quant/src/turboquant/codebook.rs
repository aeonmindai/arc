...
static D64_2BIT_BOUNDARIES: [f32; 5] = [-1.0, -0.122005887276, 0.0, 0.122005887276, 1.0];
...
static D128_2BIT_BOUNDARIES: [f32; 5] = [-1.0, -0.086516601451, 0.0, 0.086516601451, 1.0];
...
static D256_2BIT_BOUNDARIES: [f32; 5] = [-1.0, -0.061263256296, 0.0, 0.061263256296, 1.0];
...
mod tests {
    ...
    fn test_mse_matches_paper() {
        ...
        assert!(
            (total_mse_2 - 0.117).abs() < 0.005,
            "2-bit MSE: {total_mse_2}"
        );
        assert!(
            (total_mse_3 - 0.03).abs() < 0.005,
            "3-bit MSE: {total_mse_3}"
        );
        assert!(
            (total_mse_4 - 0.009).abs() < 0.001,
            "4-bit MSE: {total_mse_4}"
        );
    }
}
