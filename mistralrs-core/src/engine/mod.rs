            ...
            match scheduled {
                SchedulerOutput::DefaultScheduler {
                    ...
                    if !scheduled.completion.is_empty() {
                        ...
                        // carries the batch this profile describes.
                        ...
                        // orders of magnitude larger and averaging the two under
                        // one node would hide the decode cost being hunted.
                        ...
                        let res = {
                            ...
                            // at the end of it, so time spent waiting for it is
                            // a scheduling cost worth naming.
                            let mut pipeline = {
