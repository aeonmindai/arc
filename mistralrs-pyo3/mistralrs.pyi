...
class Runner:
    def __init__(
        ...
        - `pa_cache_type` sets the PagedAttention KV cache type. Defaults to `TurboQuant` (K4/V3, 3.5-bit), **not** to `Auto`: a standard-layout head_dim-128 model
            gets quantized KV and loses prefix caching unless you pass `Auto`. Other geometries fall back to `Auto` with a warning. Quality under TurboQuant has
            never been evaluated by Arc. Options: Auto, F8E4M3, TurboQuant, TurboQuant3, TurboQuantAggressive.
